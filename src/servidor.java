...
public class servidor {
    ...
    public static void main(String[] args) throws IOException {
        ...
        servidorPrincipal.conectar(Integer.parseInt(puerto));
...
/*
        ...
        while (true) {
            ...
            switch (opcion){
                case 1:
                    System.out.println("Ha seleccionado crear empleado");
                    System.out.println("Escriba el numero de cedula del nuevo empleado");
                    cedula=scanner1.nextInt();
                    System.out.println("Escriba el nombre del empleado");
                    nombre= scanner1.nextLine();
                    System.out.println("Escriba el primer apellido");
                    primer_apellido=scanner1.nextLine();
